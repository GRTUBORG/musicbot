...
async def on_member_join(member):
    ...
    embed.add_field(name = "Приветственное сообщение", value = f"Добро пожаловать в Dark Neon City!\n"
                                                               ...
                                                               '\n'
                                                               f"На сервере, как ты заметил, присутствуют боты, информацию о них можешь найти в <#743768257374322748>.\n"
                                                               '\n'
...
async def version(ctx):
    ...
    embed = discord.Embed(title = "Актуальная версия бота", description= '__Апдейт был 14.09.2020 до v. 3.2__. \n' 'Добавлено/обновлено:\n'
                          ...
                          '• Также активно идёт работа с часовыми поясами, дабы дата была не в UTC-формате\n'
