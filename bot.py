...
command_list = ['Не за что!', 'Рад был помочь)', 'Тебе спасибо!', 'Ой, засмущал меня...', 'Обращайся :)', 'Нет, ну серьёзно, тут нет моей заслуги)', 'Хэй, это тебе спасибо 💚', 'Почаще обращайся ко мне 💚']
