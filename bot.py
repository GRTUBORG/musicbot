...
async def on_member_join(member):
    ...
    embed.add_field(name = f"Добро пожаловать в Dark Neon City!\n"
                    ...
                    '\n'
                    'Тебе дана роль <@556790746317848580>, поэтому, пока что, тебе доступны не все функции сервера. Но ты можешь участвовать в ивентах, чтобы повысить свой ранг!\n'
                    '\n'
                    ...
                    '\n'
                    'По интересующим вопросам обращайся к <@526479728798990338>.\n'
                    '\n'
