...
async def on_member_join(member):
    ...
    embed.add_field(name = "Приветственное сообщение", value = "Добро пожаловать в Dark Neon City!\n"
                                                               ...
                                                               '\n'
                                                               "На сервере, как ты заметил, присутствует бот, информацию о нём можешь найти в <#743768257374322748>.\n"
                                                               '\n'
                                                               'По интересующим вопросам, а также по вопросам разбана обращайся к `@Смотрящий`.\n'
                                                               '\n'
