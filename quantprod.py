...
async def on_member_join(member):
    ...
    embed.add_field(name = "Приветственное сообщение", value = "Добро пожаловать на ламповый сервер __Dark Neon City__!\n"
                                                               '\n'
                                                               ...
                                                               '\n'
                                                               "На сервере, как ты заметил, присутствует собственный бот (<@734443917130465420>), информацию о нём можешь найти в <#743768257374322748>.\n"
                                                               '\n'
                                                               'По интересующим вопросам обращайся к `@Смотрящий`.\n'
                                                               'Оу да, и по вопросам разбана тоже пиши `@Смотрящий`, ну, то есть <@394850460420538389>.\n'
                                                               '\n'
                                                               "Не забывай следить за новостями <#541231102333943832> и обновлениями правил в <#526099119874375710>. Будь активен на сервере и однажды появишься на <#741002854898073660>!\n"
                                                               '\n'
                                                               "С наилучшими пожеланиями, администрация сервера. Располагайся 💚")
