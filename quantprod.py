...
async def on_member_join(member):
    ...
    embed.add_field(name = "Приветственное сообщение", value = "Добро пожаловать на ламповый сервер Dark Neon City!\n"
                                                               ...
                                                               '\n'
                                                               "На сервере, как ты заметил, присутствует собственный бот, информацию о нём можешь найти в <#743768257374322748>.\n"
                                                               '\n'
                                                               'По интересующим вопросам обращайся к `@Смотрящий`.\n'
                                                               f'Оу да, и по вопросам разбана тоже пиши `@Смотрящий`, ну, то есть <@394850460420538389>, да.\n'
                                                               '\n'
                                                               f'Не забывай следить за новостями в <#541231102333943832> и обновлениями правил в <#526099119874375710>. Будь активен на сервере и однажды появишься на <#741002854898073660>!\n'
                                                               '\n'
