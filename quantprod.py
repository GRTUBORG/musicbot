...
Bot = commands.Bot(command_prefix = ["/", "!", "qp!", "бот ", "quantprod ", "quant ", "<@&734445461360082994> "], intents = discord.Intents.all())
...
async def on_member_join(member):
    ...
    await member.send("Добро пожаловать на ламповый сервер Dark Neon City!\n"
                      ...
                      'Не забывай следить за новостями в <#541231102333943832> и обновлениями правил в <#526099119874375710>. Будь активен на сервере и однажды появишься на `#доска-почёта`!\n'
